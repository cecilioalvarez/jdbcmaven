...
public class Principal11 {
	...
	public static void main(String[] args) {
		...
		Filtro<Persona>f2= (Persona p)->p.getApellidos().equals("alvarez");
		
		Filtro<Persona> combinado= f2.or(p->p.getApellidos().equals("perez"));
	...
	public static  List<Persona> filtrarPersonas(Filtro<Persona> filtro ,List<Persona> lista) {
